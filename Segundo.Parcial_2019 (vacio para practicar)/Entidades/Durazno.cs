...
namespace Entidades
{
    ...
    public class Durazno:Fruta
    {
        ...
        public Durazno(string color, double peso, int _cantPelusa) : base(color, peso)
        {
            this._cantPelusa = _cantPelusa;
        }
        public override string ToString()
        {
            return $"{this.Nombre} - {this.FrutaToString()} - {this._cantPelusa}";
        }
    }
}
